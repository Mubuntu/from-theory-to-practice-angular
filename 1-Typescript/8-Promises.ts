...
*/
var promise = new Promise((resolve, reject) => { // resolve and reject are in fact functions themselvess
    setTimeout(() => {
...
let promise2 = Promise.resolve('completed');
...
Promise.resolve('volbracht')
    .then((val) => { throw new Error("gefaald") })
