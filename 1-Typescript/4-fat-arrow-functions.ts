...
setTimeout(() => console.log('setTimeout called anonymously with a fat arrow syntax'), 2000);
/*
...
let obj2 = {
    name: "mubuntu",
    sayLater: function () { // not sure why this changes when this is a fat arrow function seeing as this stays the same outside the fat-arrow syntax
        console.log(this);
        setTimeout(() => {
            console.log(this);
